      ...
      <div class="content">
        ...
        <div class="navbox" @click="$router.push({path: './convolution'})">
          <div class="left">
            ...
            <div class="text">
              <div class="t">卷积</div>
              <div class="l">神经网络卷积BTC兑换RCP</div>
            </div>
          </div>
          <div class="r">
